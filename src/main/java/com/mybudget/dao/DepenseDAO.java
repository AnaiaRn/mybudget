...
public class DepenseDAO {
    ...
    public void ajouterDepense(Depense depense) {
        String sql = "INSERT INTO depense (montant, date_depense, description, utilisateur_id, categorie_id,) VALUE (?, ?, ?, ?, ?)";
        ...
        try(Connection conn = ConnexionDB.getConnection();
            ...
            stmt.setInt(4, depense.getUtilisateurId());
    ...
    public List<Depense> getAll() {
        ...
        PreparedStatement stmt = conn.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                d.setDescription((rs.getString("desription")));
    ...
    public void updateDepense(Depense depense) {
        String sql = "UPDATE depense SET montant = ?, date_depense = ?, description = ?, utilisateur_id = ?, categorie_id = ? WHERE id = ?";
        try (Connection conn = ConnexionDB.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
